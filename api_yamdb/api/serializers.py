...
class SignUpSerializer(serializers.ModelSerializer):
    ...
    email = serializers.EmailField(
        validators=[UniqueValidator(User.objects.all())], required=True
    )
    ...
    class Meta:
        ...
        validators = [
            UniqueTogetherValidator(
                queryset=Title.objects.all(), fields=(
                    "name",
                    "year",
                    "category"
                )
...
class ReviewsSerializer(serializers.ModelSerializer):
    ...
    title = serializers.PrimaryKeyRelatedField(
        many=False, default=CURRENT, queryset=Title.objects.all()
    )
    ...
    class Meta:
        ...
        validators = [
            UniqueTogetherValidator(
                queryset=Review.objects.all(), fields=(
                    "text",
                    "author",
                    "title"
                )
...
class CommentsSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        if "text" not in data.keys():
            result = dict.fromkeys("text", "This field is required!")
